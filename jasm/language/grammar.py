...
GRAMMAR = r"""
    ...
    MNEMONIC.100: /(GET|PUT|MOV|PUSH|POP|ADD|ADC|SUB|SBC|MUL|MOD|DIV|INC|DEC|LSH|RSH|AND|OR|NOT|XOR|INB|OUTB|CMP|JMP|JZ|JNZ|JC|JNC|JA|JAE|JB|JBE|JG|JGE|JL|JLE|CALL|RET|INT|IRET|HALT|NOP)\b/i
